...
struct RepairDevicePresenceSourceConstraintForExpandedLocationUploadSources: AsyncMigration {
    ...
    func revert(on db: any Database) async throws {
        try await UpdateDevicePresenceSourceConstraintForExpandedLocationUploadSources().prepare(on: db)
    }
}
