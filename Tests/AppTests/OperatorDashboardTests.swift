    ...
    func dashboardPageRendersSnapshot() async throws {
        try await withApp { app in
            ...
            try await app.testing().test(.GET, "dashboard", afterResponse: { res async in
                ...
                #expect(res.body.string.contains("Compact operational KPIs"))
                ...
                #expect(res.body.string.range(of: "Model Pipeline")!.lowerBound < res.body.string.range(of: "Growth / Usage")!.lowerBound)
                #expect(res.body.string.range(of: "Growth / Usage")!.lowerBound < res.body.string.range(of: "NWS / Alert Activity")!.lowerBound)
                ...
                #expect(res.body.string.contains("UGC Codes: COC005, COC013"))
